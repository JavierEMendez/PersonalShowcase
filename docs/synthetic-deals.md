...
## Sawyer Bend Apartments (Multifamily Screening Tool)

The broker package for this deal exists as three synthetic files in `data/sawyer_bend/` (offering memorandum PDF, rent roll xlsx, T-12 xlsx), generated by `scripts/make_sawyer_bend_docs.py` from the seed inputs. The Screen step reads them; `evals/screen/expected.json` records what it should find. The seller's T-12 runs below the buyer's underwriting on controllables ($3,680 against $3,850 per unit) and insurance ($720 against the $850 quote), and carries taxes on the 2025 assessment; those three gaps are what the question loop is for.
...
| Unlevered IRR | 10.2% |
| Levered IRR | 14.8% |
| Levered LP IRR against the 15% floor | 13.0%; the floor is reached at a $43.7M bid (13.4% below ask), where the levered IRR is 18.1% |
...
The recommendation is a valuation range solved from levered LP IRR targets: 13% sets the max, 15% the mid, and the low is the lower of the 17% price and 20% below the ask. Base case: low $40.4M (the 20% cap binds; the 17% price is $41.6M), mid $43.7M, max $46.0M, against a $50.5M ask that returns 7.9% to the LP. Verdict: engage.

Recommendation: worth a full underwriting only if the seller engages at or below $46.0M, 8.9% below the $50.5M ask. Open at $43.7M ($151,840 per unit); $40.4M is the price to buy with confidence. At the ask the levered LP IRR is 7.9%.

At $43.7M the deal shows a 6.14% going-in cap, an 18.1% levered IRR, a 2.14× multiple and a year 1 DSCR of 1.64× against a 1.25× covenant. At the $50.5M ask the going-in cap is 5.04%, the levered IRR 7.9% and the levered LP IRR 7.9%. Returns are most sensitive to market rent growth; the renovation premium carries the value-add thesis; no single stress breaches the covenant.

What the model cannot tell you: whether the appraisal district reassesses to the purchase price (taxes are 39% of operating expenses); whether the $145 premium holds once 120 more renovated units reach the submarket; the condition of roofs and HVAC beyond the property condition sample; the seller's appetite for a price 8.9% below ask.

### Monitor
Removed on 2026-09-14: the tool screens deals; post-close monitoring is a different job.
